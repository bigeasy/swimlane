(function() {
  ...
  Swimlane = (function() {
    ...
    Swimlane.prototype.keypress = function(e) {
      ...
      charCode = $.browser.msie ? e.keyCode : e.charCode;
  ...
  if ($.browser.msie) {
    Cursor = (function() {
      ...
      Cursor.prototype.read = function() {
        ...
        this.offset += iterator.data.length;
        this.node = range.parentElement();
        this.offset = offset;
      ...
      Cursor.prototype.select = function(node, offset) {
        ...
        if (this.offset === 0) {
          ...
          range.move("character", this.offset + 1);
          range.move("character", this.offset - 1);
          range.collapse();
        } else {
          range.moveToElementText(this.node);
          range.collapse();
          range.move("character", this.offset);
        }
        range.select();
        return this;
      };
